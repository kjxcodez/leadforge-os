---
title: "ADR-007: Dependency Rules & Import Restrictions"
description: "Architectural Decision Record 7 mapping core software structure decisions."
category: "ADRs"
order: 7
---
...
flowchart TD
  Opt0["Trust-Based Enforcement"] -->|Rejected| Decision{Decision: Dependency Rules & Import Restrictions}
  Opt1["Bespoke Monorepo Linting Scripts"] -->|Rejected| Decision{Decision: Dependency Rules & Import Restrictions}
  Opt2["Pros"] -->|Rejected| Decision{Decision: Dependency Rules & Import Restrictions}
  Opt3["Cons"] -->|Rejected| Decision{Decision: Dependency Rules & Import Restrictions}
  Chosen["Dependency Rules & Import Restrictions"] -->|Chosen| Decision
```
