---
title: "ADR-010: Distributed Data Model"
description: "Architectural Decision Record 10 mapping core software structure decisions."
category: "ADRs"
order: 10
---
...
flowchart TD
  Opt0["Direct Cloud Write"] -->|Rejected| Decision{Decision: Distributed Data Model}
  Opt1["Pros"] -->|Rejected| Decision{Decision: Distributed Data Model}
  Opt2["Cons"] -->|Rejected| Decision{Decision: Distributed Data Model}
  Chosen["Distributed Data Model"] -->|Chosen| Decision
```
