---
title: "ADR-004: Scoped Memory Model"
description: "Architectural Decision Record 4 mapping core software structure decisions."
category: "ADRs"
order: 4
---
...
flowchart TD
  Opt0["Single JSON Memory File"] -->|Rejected| Decision{Decision: Scoped Memory Model}
  Opt1["Cloud Vector Host"] -->|Rejected| Decision{Decision: Scoped Memory Model}
  Opt2["Pros"] -->|Rejected| Decision{Decision: Scoped Memory Model}
  Opt3["Cons"] -->|Rejected| Decision{Decision: Scoped Memory Model}
  Chosen["Scoped Memory Model"] -->|Chosen| Decision
```
