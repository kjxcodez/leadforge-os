...
flowchart TD
  Opt0["Monolithic AI Package"] -->|Rejected| Decision{Decision: AI Runtime Responsibilities}
  Opt1["Direct Integration"] -->|Rejected| Decision{Decision: AI Runtime Responsibilities}
  Opt2["Pros"] -->|Rejected| Decision{Decision: AI Runtime Responsibilities}
  Opt3["Cons"] -->|Rejected| Decision{Decision: AI Runtime Responsibilities}
  Chosen["AI Runtime Responsibilities"] -->|Chosen| Decision
```
