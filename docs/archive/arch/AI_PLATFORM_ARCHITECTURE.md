...
_Explicitly excludes: API keys, SMTP passwords, session cookies, database handles._
...
_Each error exposes an `isRetryable: boolean` property to determine backoff paths._
