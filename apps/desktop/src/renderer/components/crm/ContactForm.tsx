 ...
 */
export function ContactForm({ initialValues, companies = [], onSubmit, onCancel, isLoading = false }: ContactFormProps) {
  const {
    register,
    handleSubmit,
    formState: { errors },
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1">
          ...
          />
          {errors.firstName && <span className="text-[10px] text-danger-text">{errors.firstName.message}</span>}
        </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1">
          ...
          <Input
            ...
            className="text-xs h-8"
          />
          {errors.email && <span className="text-[10px] text-danger-text">{errors.email.message}</span>}
        </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="space-y-1">
          <Label htmlFor="companyId" className="text-xs font-semibold">Company Relationship</Label>
          <select
            id="companyId"
            {...register('companyId')}
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1">
          <Label htmlFor="linkedin" className="text-xs font-semibold">LinkedIn Profile / Handle</Label>
          <Input
            id="linkedin"
