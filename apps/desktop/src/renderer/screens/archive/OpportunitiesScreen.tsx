...
const initialDeals = [
  ...
  { id: 2, name: 'Stellar Tech Pilot', company: 'Stellar Tech', value: '$4,500', stage: 'Contacted' },
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200 text-xs">
      <div>
        ...
        <p className="text-[11px] text-secondary mt-0.5">Track deal pipelines and estimated revenue values.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 h-[calc(100vh-200px)] overflow-y-auto">
        {stages.map((stage) => {
          ...
          return (
            <div key={stage} className="bg-sunken border border-border-subtle rounded-lg p-3 flex flex-col space-y-3 h-fit min-h-[150px]">
              ...
              <div className="space-y-2">
                {stageDeals.map((deal) => (
                  <div key={deal.id} className="bg-card border border-border-subtle p-3 rounded shadow-sm hover:border-border-default transition-colors space-y-2">
